...
| [`TypedLoadOptions`](https://docs.rs/dspy-rs/latest/dspy_rs/data/v1/dataloader/struct.TypedLoadOptions.html) | Options for schema-driven typed loading. |
...
| [`UnknownFieldPolicy`](https://docs.rs/dspy-rs/latest/dspy_rs/data/v1/dataloader/enum.UnknownFieldPolicy.html) | Controls how typed loaders handle source fields that are not part of the target signature. |
