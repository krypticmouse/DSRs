...
- [LM](/docs/reference/lm): `ToolSet` and the tool loop that `run_js` drops into.
- [Runtime](/docs/reference/runtime): `RuntimeEnv`, `with_sandbox`, `with_code_mode`, and the load-time checks.
- [Add Tools](/docs/guides/add-tools): writing host and sandboxed tools.
- [Give the Model Hands](/docs/learn/give-the-model-hands): the concept chapter on tools and Code Mode.
