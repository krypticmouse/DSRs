...
Need exact method signatures or field-level documentation? The generated Rust docs on [docs.rs/dsrs](https://docs.rs/dsrs/latest/dsrs/core/lm/) reflect the inline doc comments from the source of `LM`, `LMConfig`, and related types.
