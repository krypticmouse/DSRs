...
`LMConfig` centralizes inference settings. All fields have sensible defaults, so you can override only what you need. The builder exposes fluent setters for each field.
