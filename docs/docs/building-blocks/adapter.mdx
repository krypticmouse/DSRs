...
Here's what a prompt looks like for a complex nested type (from [`16-insurance-claim-prompt.rs`](https://github.com/darinkishore/DSRs/blob/main/crates/dsrs-lm/examples/16-insurance-claim-prompt.rs)):
