...
- Prompt/render effects: `crates/dsrs-macros/tests/test_bamltype_docs_contract.rs`
- Basic `#[BamlType]` end-user contract: `crates/dsrs-macros/tests/test_bamltype_attr_contract.rs`
