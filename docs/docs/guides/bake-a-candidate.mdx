...
- [Optimizer engine reference](/docs/reference/optimizer-engine): where candidates and overlays come from during optimization, and how checkpointing saves them
- [Print and serve](/docs/guides/print-and-serve): shipping the baked file
