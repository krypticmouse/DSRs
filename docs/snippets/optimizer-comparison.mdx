...
GEPA is the only optimizer that requires textual feedback from the metric (`Eval::with_feedback`). The others use numerical scores alone. Full configuration tables for all five live in the [optimizers reference](/docs/reference/optimizers).
