...
use crate::typesys::{OutputSchema, Schema};
...
///
/// The type system IS the signature — there's no string DSL like Python DSPy's
...
pub trait Signature: Send + Sync + 'static {
    ...
    /// The output type schema used by the adapter for structured output parsing.
